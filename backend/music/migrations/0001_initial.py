# Generated by Django 5.0.4 on 2025-03-03 14:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followers', models.ManyToManyField(blank=True, to='music.customuser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Song',
            fields=[
                ...
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.customuser')),
                ('likes', models.ManyToManyField(blank=True, related_name='liked_songs', to='music.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Playlist',
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.customuser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.customuser')),
